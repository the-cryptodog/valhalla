...
class DrawLotsViewModel: ViewModel() {
    private val _saveStepShakeVisible = MutableLiveData<Boolean>()//千筒判斷
    private val _saveDivinationBlocks = MutableLiveData<Boolean>()//千判斷
    private val _saveStepThrowVisible = MutableLiveData<Boolean>()//千判斷
    private val _saveStepAnswer = MutableLiveData<Int>()
